...
(function($){
  ...
  $.fn.mColorPicker.drawPicker = function () {
    ...
    $(document.createElement("div")).attr(
      ...
      '<div id="mColorPickerWrapper" class=""><div id="mColorPickerImg" class="mColor"></div><div id="mColorPickerImgGray" class="mColor"></div><div id="mColorPickerSwatches"><div class="mClear"></div></div><div id="mColorPickerSwatches2"><div class="mClear"></div></div><div id="mColorPickerFooter"><input type="text" size="8" id="mColorPickerInput"/></div></div>'
    ).appendTo("body");
    ...
    for (n = 19; n > 9; n--) {
      ...
      $(document.createElement("div")).attr({
        'id': 'cell2' + n,
        'class': "mPastColor mNoTopBorder" + ((n > 10)? ' mNoLeftBorder': '')
      }).html(
        '&nbsp;'
      ).prependTo("#mColorPickerSwatches2");
    }
    ...
    $('#mColorPickerSwatches, #mColorPickerSwatches2').css({
